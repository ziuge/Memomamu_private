...
enum Constants {
    ...
    enum Font {
        static let head = UIFont(name: NSLocalizedString("fontName", comment: "폰트 이름"), size: 24)
        static let title = UIFont(name: NSLocalizedString("fontName", comment: "폰트 이름"), size: 20)
        static let cardTitle = UIFont(name: NSLocalizedString("fontName", comment: "폰트 이름"), size: 18)
